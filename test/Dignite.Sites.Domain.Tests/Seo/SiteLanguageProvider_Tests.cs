...
/// </summary>
public class SiteLanguageProvider_Tests : SitesDomainTestBase<SitesDomainTestModule>
{
    ...
    {
        _settings.Set(SitesSettings.EnabledLanguages, "fr, en , zh-Hans");
    ...
    {
        _settings.Set(SitesSettings.EnabledLanguages, "EN,en,ZH-hans");
    ...
    {
        _settings.Set(SitesSettings.EnabledLanguages, "en,not-a-culture-at-all,fr");
    ...
    {
        _settings.Set(SitesSettings.EnabledLanguages, configured);
