...
After building your library with `ng build site`, go to the dist folder `cd dist/site` and run `npm publish`.

## Running unit tests

Run `ng test site` to execute the unit tests via [Karma](https://karma-runner.github.io).
