...
/// overrides below are the only things it cannot know: the name of Site' own foreign key, and how to
/// build one of Site' own rows.
/// </para>
/// <para>
...
public class ContentFlexFieldIndexManager
    : EfCoreFlexFieldIndexManagerBase<ISiteDbContext, Content, ContentFlexFieldIndex>,
