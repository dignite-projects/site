...
public class RobotsTxtBuilder : DomainService
{
    ...
    {
        var allowIndexing = await SettingProvider.IsTrueAsync(SitesSettings.Robots.AllowIndexing);
        var allowAiTraining = await SettingProvider.IsTrueAsync(SitesSettings.Robots.AllowAiTraining);
        var allowAiSearch = await SettingProvider.IsTrueAsync(SitesSettings.Robots.AllowAiSearch);
