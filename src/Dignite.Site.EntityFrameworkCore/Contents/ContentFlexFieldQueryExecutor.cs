...
/// <para>
/// This is the fix for the specific weakness Site inherited the model from. Dignite.Cms stored field
...
public class ContentFlexFieldQueryExecutor
    : EfCoreFlexFieldQueryExecutorBase<ISiteDbContext, Content, ContentFlexFieldIndex>,
      ITransientDependency
{
    protected override string EntityIdPropertyName => nameof(ContentFlexFieldIndex.ContentId);

    public ContentFlexFieldQueryExecutor(IDbContextProvider<ISiteDbContext> dbContextProvider)
