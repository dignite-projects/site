...
/// Sites - but the <i>ordering</i> is the caller's to get right, and getting it wrong silently destroys
...
public class FieldManager : DomainService
{
    ...
    /// <item>rewrite the value bags - once per host type, and <c>Content</c> is Sites' only one.</item>
    /// </list>
    /// <para>
