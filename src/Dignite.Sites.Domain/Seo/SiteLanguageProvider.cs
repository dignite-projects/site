...
/// <summary>
/// Reads <see cref="SitesSettings.EnabledLanguages"/> and answers which languages this site serves and
...
public class SiteLanguageProvider : DomainService
{
    ...
    {
        var configured = await SettingProvider.GetOrNullAsync(SitesSettings.EnabledLanguages);
