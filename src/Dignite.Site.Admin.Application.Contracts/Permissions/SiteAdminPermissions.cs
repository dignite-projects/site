...
public class SiteAdminPermissions
{
    public const string GroupName = "SiteAdmin";
    ...
    {
        return ReflectionHelper.GetPublicConstantsRecursively(typeof(SiteAdminPermissions));
    }
}
