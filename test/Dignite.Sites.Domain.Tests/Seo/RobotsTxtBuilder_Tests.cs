...
/// </summary>
public class RobotsTxtBuilder_Tests : SitesDomainTestBase<SitesDomainTestModule>
{
    ...
    public RobotsTxtBuilder_Tests()
    {
        ...
        _settings.Set(SitesSettings.PrimaryDomain, "https://acme.example");
    }
    ...
    {
        _settings.Set(SitesSettings.Robots.AllowAiTraining, allowTraining.ToString().ToLowerInvariant());
    ...
    {
        _settings.Set(SitesSettings.Robots.AllowAiSearch, allowSearch.ToString().ToLowerInvariant());
    ...
    {
        _settings.Set(SitesSettings.Robots.AllowIndexing, "false");
        _settings.Set(SitesSettings.Robots.AllowAiTraining, "true");
        _settings.Set(SitesSettings.Robots.AllowAiSearch, "true");
