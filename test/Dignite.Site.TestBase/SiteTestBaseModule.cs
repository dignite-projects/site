...
/// <para>
/// Deliberately does <b>not</b> seed data. <c>Dignite.Site.Domain.Tests</c> and
/// <c>Dignite.Site.Application.Tests</c> both build on this module and have no database - any
...
/// Seeding is instead triggered by <c>SiteEntityFrameworkCoreTestModule</c> (and would be by a MongoDB
