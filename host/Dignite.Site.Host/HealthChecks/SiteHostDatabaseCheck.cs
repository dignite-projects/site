...
namespace Dignite.Site.Host.HealthChecks;

public class SiteHostDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SiteHostDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
