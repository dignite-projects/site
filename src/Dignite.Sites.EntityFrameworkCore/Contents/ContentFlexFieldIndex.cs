...
/// and every row here is re-derivable from it. Sites needs exactly one such table, because <c>Content</c>
...
/// in Sites' domain layer knows this type exists.
/// </para>
/// </summary>
public class ContentFlexFieldIndex : FlexFieldIndexBase<Content>, IMultiTenant
{
    ...
    /// <summary>
    /// Sites' own foreign key - the kernel maps no relationships, so the host declares and maps this
    /// itself.
    /// </summary>
