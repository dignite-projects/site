...
using Dignite.Sites.Host.Data;
using Dignite.Sites.Host.Localization;
using Dignite.Sites.Host.Menus;
using Dignite.Sites.Host.Permissions;
using Dignite.Sites.Host.HealthChecks;
...
public class HostModule : AbpModule
{
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.Contributors.Add(new HostToolbarContributor());
        });
    }
