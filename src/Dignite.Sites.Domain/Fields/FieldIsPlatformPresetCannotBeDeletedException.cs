...
/// <summary>
/// A platform preset field (currently: the SEO field, <c>Dignite.Sites.Seo.SeoFieldNames.FieldName</c>) was
...
public class FieldIsPlatformPresetCannotBeDeletedException : BusinessException
{
    public FieldIsPlatformPresetCannotBeDeletedException(Guid fieldId, string name)
        : base(SitesErrorCodes.FieldIsPlatformPresetCannotBeDeleted)
    {
