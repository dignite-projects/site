...
public class ContentAdminAppService_Tests : SitesEntityFrameworkCoreTestBase
{
    ...
    public async Task Should_Create_A_Content_With_A_Multi_Select_Value()
    {
        ...
        {
            ContentTypeId = SitesTestData.PostArticleTypeId,
            CultureName = SitesTestData.EnglishCulture,
            Slug = "admin-create-content-test",
            PublishTime = SitesTestData.PublishTime,
