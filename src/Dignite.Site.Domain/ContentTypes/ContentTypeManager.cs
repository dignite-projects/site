...
public class ContentTypeManager : DomainService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // PageId would be invisible to every route, since resolution starts from the page.
        await PageRepository.GetAsync(pageId, cancellationToken: cancellationToken);
