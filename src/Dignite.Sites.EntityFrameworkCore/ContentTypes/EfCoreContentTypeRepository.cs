...
public class EfCoreContentTypeRepository : EfCoreRepository<ISitesDbContext, ContentType, Guid>, IContentTypeRepository
{
    public EfCoreContentTypeRepository(IDbContextProvider<ISitesDbContext> dbContextProvider)
