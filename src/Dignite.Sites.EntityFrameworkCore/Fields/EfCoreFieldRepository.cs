...
/// "FlexFieldRepository" - this one does not, so <c>SitesEntityFrameworkCoreModule</c> binds it
/// explicitly. The base class documents that requirement.
/// </para>
/// </summary>
public class EfCoreFieldRepository : EfCoreFlexFieldRepositoryBase<ISitesDbContext, Field>, IFieldRepository
{
    public EfCoreFieldRepository(IDbContextProvider<ISitesDbContext> dbContextProvider)
