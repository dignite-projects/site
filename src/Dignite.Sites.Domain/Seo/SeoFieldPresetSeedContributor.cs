...
/// in Domain. <c>Dignite.Sites.Domain.Tests</c> has no database and would fail to construct this (ABP
...
/// <c>SitesEntityFrameworkCoreTestModule</c>, not from the shared <c>SitesTestBaseModule</c> every test
