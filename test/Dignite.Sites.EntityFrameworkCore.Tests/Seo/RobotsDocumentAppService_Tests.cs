...
/// </summary>
public class RobotsDocumentAppService_Tests : SitesEntityFrameworkCoreTestBase
{
    ...
    [Fact]
    public async Task Llms_Txt_Should_List_The_Sites_Pages_When_Enabled()
    {
        _settings.Set(SitesSettings.EnableLlmsTxt, "true");
